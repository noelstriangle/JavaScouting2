...
public class TeamDetailsFragment extends Fragment {
    ...
    void populateTable(Team team, TableLayout tl) {
        ...
        tempq.setTextSize(22);
        tempa.setTextSize(22);
        tempq.setText("Avg Auto:");
        tempq.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempa.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempq.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setText(String.valueOf(team.autoPoints));
        tempr.addView(tempq);
        tempr.addView(tempa);
        tl.addView(tempr, 8);
        tempr = new TableRow(getContext());
        ...
        tempq.setTextSize(22);
        tempa.setTextSize(22);
        tempq.setText("Avg Tele:");
        tempq.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempa.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempq.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setText(String.valueOf(team.telePoints));
        tempr.addView(tempq);
        tempr.addView(tempa);
        tl.addView(tempr, 9);
        tempr = new TableRow(getContext());
        ...
        tempq.setTextSize(22);
        tempa.setTextSize(22);
        tempq.setText("Avg End:");
        tempq.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempa.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempq.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setText(String.valueOf(team.endPoints));
        tempr.addView(tempq);
        tempr.addView(tempa);
        tl.addView(tempr, 10);
        tempr = new TableRow(getContext());
        ...
        tempq.setTextSize(22);
        tempa.setTextSize(22);
        tempq.setText("Avg STD:");
        tempq.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempa.setBackground(getActivity().getDrawable(R.drawable.line_divider));
        tempq.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        tempa.setText(String.valueOf(team.standardDeviation));
        tempr.addView(tempq);
        tempr.addView(tempa);
        tl.addView(tempr, 11);
